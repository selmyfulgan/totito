Public Class codigo2
    Private nTablero(4, 4) As Integer
    ...
    Public Function pulsaBoton(ByVal n, ByVal m)
        If n >= 0 And n < 5 And m < 5 And nTablero(n, m) = -1 Then
            If nGanador = -1 Then
                nTablero(n, m) = 0
    ...
    Public Function ganarPartida()
        'verficando diagonal \
        If nTablero(0, 0) <> -1 And nTablero(0, 0) = nTablero(1, 1) And nTablero(0, 0) = nTablero(2, 2) And nTablero(0, 0) = nTablero(3, 3) And nTablero(0, 0) = nTablero(4, 4) Then
            'si retorna 0,0 gana usuario 
            'si retorna 0,1 gana la compucita
            Return nTablero(0, 0)
        End If
        'verficando diagonal /
        If nTablero(0, 4) <> -1 And nTablero(0, 4) = nTablero(1, 3) And nTablero(0, 4) = nTablero(2, 2) And nTablero(0, 4) = nTablero(3, 1) And nTablero(0, 4) = nTablero(4, 0) Then
            'si retorna 0,0 gana usuario 
        ...
        For n As Integer = 0 To 4
            If nTablero(n, 0) <> -1 And nTablero(n, 0) = nTablero(n, 1) And nTablero(n, 0) = nTablero(n, 2) And nTablero(n, 0) = nTablero(n, 3) And nTablero(n, 0) = nTablero(n, 4) Then
                'si retorna 0,0 gana usuario 
                'si retorna n, 0 gana la compucita
                Return nTablero(n, 0)
            End If
            If nTablero(0, n) <> -1 And nTablero(0, n) = nTablero(1, n) And nTablero(0, n) = nTablero(2, n) And nTablero(0, n) = nTablero(3, n) And nTablero(0, n) = nTablero(4, n) Then
                'si retorna 0,0 gana usuario 
